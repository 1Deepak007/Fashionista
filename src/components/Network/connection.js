    ...
    <div className="Connections">
      <div className="mb-24 space-y-8">
        ...
        <div className="text-center space-x-4 flex ">
          <p className="font-[Arial] text-[#A45286] text-[20px] font-[700] uppercase leading-[23px]">
            Connections
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[3rem]">
          {/* Connection Card 1 */}
          <div className="bg-[#fff] w-[251px] h-[136px] rounded-[4px] hover:shadow-md">
            {/* Top Card Container */}
            <div className="p-2">
              {/* Header Card */}
              <div className="flex px-2 justify-between items-center">
                <div className="font-[Arial] font-[700] text-[13px] leading-[14.95px] uppercase">
                  Today
                </div>
                <Image
                  alt="three dots"
              ...
              <div className="flex my-[0.93rem] px-2 gap-[0.5rem]">
                ...
                <div className="w-min h-[28px] font-[Arial] text-[12px] font-[700] text-[#A45286] uppercase">
                  New Connection
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between">
              <div className="w-[126px] h-[33px] flex justify-center items-center font-[Arial] font-[600] text-[13px] text-[#717171] border-t leading-[14.5px] hover:bg-slate-50 hover:text-[#a35285] hover:scale-105 transition-transform duration-300">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Text */}
          <span className="font-[Gotham] font-[700] text-[12px] text-[#181818] whitespace-nowrap leading-[11.48px] uppercase">
            Recent Connections
          </span>
          ...
          <div className="w-full h-[95px] flex items-center justify-between px-6 space-x-6 bg-white rounded-[4px]">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex flex-col">
                <p className="font-[Gotham] text-[#181818] font-bold text-[14px] leading-[13.4px]">
                  Brandon Wilson
                </p>
                <p className="font-[Arial] mt-2 text-[#181818] text-[10px] font-[400] leading-[15px]">
                  Senior graphic designer
                </p>
                <span className="font-[Gotham] mt-1 text-[#A45286] text-[10px] leading-[15px]">
                  623 connections
                </span>
              </div>
            </div>
            ...
            <div className="flex space-x-2">
              <button className="w-[91px] h-[32px] flex justify-center items-center rounded-[4px] uppercase bg-gradient-to-r from-[#c166a0] via-[#A45286] to-[#c166a0]">
                <span className="font-[Arial] font-[700] text-[#FFFFFF] text-[12px] leading-[13.8px]">
                  Accept
                </span>
              </button>
              <button className="w-[91px] h-[32px] flex justify-center items-center border-[#E7E7E7] border-[1px] rounded-[4px] uppercase font-[Arial] font-[700] text-[#B7B7B7] text-[12px] leading-[13.8px] transition-all duration-300 hover:border-red-500 hover:text-red-500">
                Decline
              </button>
            </div>
          </div>
