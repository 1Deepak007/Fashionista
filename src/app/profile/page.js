      ...
      <div className="flex space-y-4 gap-8 ml-[9.5rem] mt-[3rem]">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-12 w-[850px] h-[64px] shadow-lg grid grid-cols-3 items-center border-b">
            <button
              ...
              className={`w-full font-[Gotham] font-bold h-full border-r last:border-r-0 ${
                activeSection === "profile" ? "bg-[#A45286] text-white"
                  : "bg-gray-200"
              }`}
            >
              Profile
                ...
                <div className="p-4">
                      ...
                      <div className="flex space-x-4">
                        ...
                        <div>
                          <p className="text-gray-600 mb-3">
                            ...
                            elit. Aliquam in, iure temporibus impedit delectus
                            sed repellendus...
                          </p>
                  ...
                  {activeSectionPost === "videos" && (
                    <div>
                      ...
                      <p>
                        Check out this video about technology and innovation...
                      </p>
                    </div>
                  )}
          ...
          <div className="w-[850px] mt-8 shadow-lg h-[228px] p-4">
            ...
            {/* See More Section */}
            <p className="mt-4 text-left pr-4">
                ...
                <div className="flex items-center space-x-4 p-2 rounded-lg shadow-md">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      Voluptatem molestias dolorem excepturi qui maxime modi
                      fugit vitae officiis.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full h-full">
              <div className="flex items-center space-x-4 p-2 rounded-lg shadow-md">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Voluptatem molestias dolorem excepturi qui maxime modi fugit
                    vitae officiis.
                  </p>
                </div>
              </div>
          ...
          <div className="">
            <div className="h-[360px] shadow-lg">
              ...
              <div className="flex flex-col m-4 mt-4">
                <div className="flex flex-col w-[83px] h-[71px] mb-6">
                  <span className="text-[#A45286] rounded-md hover:bg-[#A45286]  font-arial font-bold text-[45px] leading-[51.75px] text-left">
                    896
                  </span>
            ...
            <div className="h-[338px] mt-5 shadow-lg ">
              <div className="flex items-center p-3">
                <span className="font-[Gotham] font-semibold text-center ml-2 ">
